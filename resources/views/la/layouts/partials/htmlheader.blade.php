<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif Simple Additive Weighting</title>
    ...
    <link href="{{ asset('la-assets/css/animate.css') }}" rel="stylesheet" type="text/css" />
