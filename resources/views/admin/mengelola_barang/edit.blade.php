        ...
        <div class="box box-success">
            <div class="box-header">
                <div style="text-align: center;">
                    <h3 class="box-title" style="font-weight: bold;">UBAH DATA BARANG</h3>
                </div>
            </div>
            <legend></legend>
            {!! Form::open(array('url' => route('admin-update-mengelola-barang', $data->id),'method'=>'POST','class'=>'form-horizontal','id'=>'form-container', 'files'=>true)) !!}
                <div class="box-body">
                @include('flash::message')
                    <div class="form-group row {{($errors->has('kode_barang')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('kode_barang', (old('kode_barang') ? old('kode_barang') : $data->kode_barang), ['id' => 'kode_barang', 'class' => 'form-control', 'placeholder' => 'Kode Barang']) !!}
                    ...
                    <div class="form-group row {{($errors->has('nama_barang')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('nama_barang', (old('nama_barang') ? old('nama_barang') : $data->nama_barang), ['id' => 'nama_barang', 'class' => 'form-control', 'placeholder' => 'Nama Barang']) !!}
                    ...
                    <div class="form-group row {{($errors->has('kategori_barang')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('kategori_barang', (old('kategori_barang') ? old('kategori_barang') : $data->kategori_barang), ['id' => 'kategori_barang', 'class' => 'form-control', 'placeholder' => 'Kategori Barang']) !!}
                    ...
                    <div class="form-group row {{($errors->has('jenis_barang')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('jenis_barang', (old('jenis_barang') ? old('jenis_barang') : $data->jenis_barang), ['id' => 'jenis_barang', 'class' => 'form-control', 'placeholder' => 'Jenis Barang']) !!}
                    ...
                    <div class="form-group row {{($errors->has('suppliers_id')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            ...
                            {!! Form::select('suppliers_id', $supplier, $data->suppliers_id, ['id' => 'jenis_barang', 'class' => 'form-control', 'placeholder' => 'Pilih Supplier']) !!}
