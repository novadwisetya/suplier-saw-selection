        ...
        <div class="box box-success">
            <div class="box-header">
                <div style="text-align: center;">
                    <h3 class="box-title" style="font-weight: bold;">TAMBAH DATA SUPPLIER</h3>
                </div>
            </div>
            <legend></legend>
            {!! Form::open(array('url' => route('admin-store-tambah-supplier'),'method'=>'POST','class'=>'form-horizontal','id'=>'form-container', 'files'=>true)) !!}
                <div class="box-body">
                @include('flash::message')
                    <div class="form-group row {{($errors->has('kode_supplier')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('kode_supplier', old('kode_supplier'), ['id' => 'kode_supplier', 'class' => 'form-control', 'placeholder' => 'Kode Supplier']) !!}
                    ...
                    <div class="form-group row {{($errors->has('nama_supplier')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('nama_supplier', old('nama_supplier'), ['id' => 'nama_supplier', 'class' => 'form-control', 'placeholder' => 'Nama Supplier']) !!}
                    ...
                    <div class="form-group row {{($errors->has('alamat')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('alamat', old('alamat'), ['id' => 'alamat', 'class' => 'form-control', 'placeholder' => 'Alamat']) !!}
                    ...
                    <div class="form-group row {{($errors->has('phone')? 'has-error' : '')}}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('phone', old('phone'), ['id' => 'alamat', 'class' => 'form-control number-only', 'placeholder' => 'No Telepon']) !!}
